...
const RESOURCE_MEANINGS: Record<DatasetArrayKey, { list: string; item: string }> = {
  emailMessages: { list: "email messages fetched successfully", item: "email message fetched successfully" },
  supportTickets: { list: "support tickets fetched successfully", item: "support ticket fetched successfully" },
  supportMessages: { list: "support messages fetched successfully", item: "support message fetched successfully" },
