...
export const CANONICAL_COLUMNS: Record<string, string[]> = {
  email_messages: ["id", "user_id", "order_id", "cart_id", "type", "subject", "body", "sent_at", "opened", "clicked"],
  support_tickets: [
    "id",
    "user_id",
    "order_id",
  ...
  product_views: ["id", "user_id", "product_id", "timestamp", "source"],
  search_queries: ["id", "user_id", "query", "timestamp", "result_count", "clicked_product_id"],
  wishlist_items: ["id", "user_id", "product_id", "added_at"],
  product_ratings: ["id", "user_id", "product_id", "order_id", "rating", "review_text", "created_at"],
  categories: ["id", "name", "slug", "parent_category_id"],
  brands: ["id", "name"],
  suppliers: ["id", "name", "country", "lead_time_days"],
  products: ["id", "sku", "name", "category_id", "brand_id", "supplier_id", "base_price", "currency", "variants"],
