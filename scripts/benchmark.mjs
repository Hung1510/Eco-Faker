...
const totalRecords =
  ...
  dataset.supportMessages.length +
  dataset.emailMessages.length;
...
const results = {
  ...
  recordCounts: {
    ...
    supportTickets: dataset.supportTickets.length,
    supportMessages: dataset.supportMessages.length,
    emailMessages: dataset.emailMessages.length,
  },
